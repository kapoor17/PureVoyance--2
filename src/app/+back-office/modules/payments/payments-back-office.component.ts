...
@UntilDestroy()
@Component({
  selector: 'nsp-payments-back-office',
  templateUrl: './payments-back-office.component.html',
  styleUrls: ['./payments-back-office.component.scss']
})
export class PaymentsBackOfficeComponent implements OnInit {
