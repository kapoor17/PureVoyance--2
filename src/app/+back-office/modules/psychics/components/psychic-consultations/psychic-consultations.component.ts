...
@UntilDestroy()
@Component({
  selector: 'nsp-psychic-consultations',
  templateUrl: './psychic-consultations.component.html',
  styleUrls: ['./psychic-consultations.component.scss']
})
export class PsychicConsultationsComponent implements OnInit {
  ...
  public updateUrl(): void {
    ...
    const url = this.router.createUrlTree(
      ['back-office', 'psychics', this.psychicId, 'consultations'],
